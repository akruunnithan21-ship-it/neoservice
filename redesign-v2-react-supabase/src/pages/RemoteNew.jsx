...
export default function RemoteNew() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      await db.saveRemoteTicket(ticket)
      vibrate('success')
      showToast('Remote session created', 'success')
      navigate('/service')
    } catch (err) {
    ...
    <div className="space-y-4 pt-4">
      <GlassCard className="p-5 animate-fade-up">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-base font-bold tracking-wider text-violet-500 font-[family-name:var(--font-heading)]">NEW REMOTE SESSION</h2>
            <span className="text-[11px] text-text-muted mt-1 block">Remote desktop support</span>
          </div>
